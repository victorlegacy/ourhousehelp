...
if(isset($_GET['_i'])){
  $id = $_GET['ll'];
    $sql = "UPDATE order_details SET transfer = 'rex' WHERE id = '$id'";
          ...
          <div class="row ">     
            ...
            <div class="col-md-12 mb-6 mb-lg-0 col-lg-6 text-center" style="background:white !important;border-radius:10px;text-align:center">
              <div class="blog_entry service-card" >
                ...
                <p style="color:black">
                  You would be contacted for the remainnig details(including price,service day(s), service time & more) right away 
                </p>
                <p style="color:black">
                  Clients who have selected cleaning, should have the neccessary materials needed. <br>
                 Mop, Broom, Hand Towels, Detergent, Hypo, Harpic, Water
                </p>
              </div>
