...
if ($package == 'cheryl' OR $package == 'cheryl_2' OR $package == 'cheryl_3') {
 ...
 // $num = 20;
  ...
  header('loction:client/index.php');
}
...
if(isset($_POST['save'])){ 
  ...
  $sql = "INSERT INTO order_details(first_name,full_name,ap_id,email,phone,service,package,day,time,gender,state,address,landmark,price,saturday) VALUES('$name','$fullname','$ap_id','$email','$phone','$service','$package','$day','$time','$gender','$state','$address','$landmark','$price','$saturday')";
