...
$range = $_POST['price_range'];
        ...
        $sql = "INSERT INTO one_time(apart,price_range) VALUES('$apart','$range')";
...
if(isset($_POST['save'])){
  ...
  $apart = $_POST['apart'];
  $range = $_POST['range'];
  $sql = "UPDATE one_time SET fname = '$fname', lname = '$lname', email = '$email', phone = '$phone', state = '$state', address = '$address', landmark = '$landmark', price_range = '$range' WHERE id ='$one_id' ";
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>You have ordered for <b>One-time cleaning & housekeeping</b> service.
