...
<style>
 ...
 <br><br><br><br><br><br>
                <div class="col-lg-12 text-center" style="padding: 30px;">
                   ...
                   <h3 class="" style="color:white"> HOME | ONE-TIME CLEANING  </h3>
                    </div>
                  </div>
                  <br><br><br><br><br><br>
              </div>
      ...
      <div class="container">
        ...
        <div class="col-12 mb-5 position-relative">
          ...
          <div class="col-md-6 mb-5 mb-lg-0 col-lg-4 text-center">
            ...
            console.log(select)
                if(text == 1){
                document.getElementById('price_range').value = '₦15,000 - ₦35,000';
    
                }else if(text == 3){
                document.getElementById('price_range').value = '₦25,000 - ₦45,000';
                }else if(text == 4){
                    document.getElementById('price_range').value = '₦35,000 - ₦55,000';
                }else{
                document.getElementById('price_range').value = '₦50,000 - ₦70,000';
                }
                " class="form-control">
                  <option value="" disabled>--choose--</option>  
                    <option value="1" >1-2 bedroom apartment</option>
                ...
                <div class="form-group col-12" style="text-align: left;">
                    ...
                    <input class="form-control" name="price_range" readonly type="text" value="₦15,000 - ₦35,000" id="price_range">
                    </div>
              </div>
